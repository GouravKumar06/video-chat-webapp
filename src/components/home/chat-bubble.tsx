...
const ChatBubble = ({ me, message, previousMessage }: ChatBubbleProps) => {
	...
	const fromAI = message.sender?.name === "GroqBot";
	const bgClass = fromMe ? "bg-green-chat" : !fromAI ? "bg-white dark:bg-gray-primary" : "bg-blue-400 text-white"; ;
		...
		return (
			<>
				...
				<div className='flex gap-1 w-2/3'>
					...
					<div className={`flex flex-col z-20 max-w-fit px-2 pt-1 pb-2 rounded-md shadow-md relative ${bgClass}`}>
	...
	return (
		<>
			...
			<div className='flex gap-1 w-2/3 ml-auto'>
				<div className={`flex  z-20 max-w-fit px-2 pt-1 pb-2 rounded-md shadow-md ml-auto relative ${bgClass}`}>
